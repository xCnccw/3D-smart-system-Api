...
exports.updateuser = (req, res) => {
    ...
    db.query(sql, [{ id: userinfo.id, username: userinfo.username, type: userinfo.type, createdAt: new Date(), updatedAt: new Date() }, userinfo.id], function (err, results) {
        // res.cc(userinfo.id)
        res.cc(userinfo)
    })
}
...
exports.updatepwd = (req, res) => {
    ...
    db.query(sql, [{ password: info.newpwd }, id, info.oldpwd], function (err, results) {
